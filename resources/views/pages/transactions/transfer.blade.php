    ...
    <div class="col-md-8">
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                @endif
                <form class="form-horizontal" action="{{url('/fund-transfer')}}" method="post">
                    ...
                    <div class="form-group">
                        <label for="inputName" class="col-sm-2 control-label">Others Account ID</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="to_account" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputSkills" class="col-sm-2 control-label">Transfer Amount( <i class="fa  fa-eur"></i> )</label>
                        <div class="col-sm-8">
